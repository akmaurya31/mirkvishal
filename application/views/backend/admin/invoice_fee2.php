                	...
                	<?php echo form_open(base_url() . 'index.php?admin/classes/create' , array('class' => 'form-horizontal form-groups-bordered validate','target'=>'_top'));?>
                        <div class="padded">
                         ...
                         <div class="form-group">
                             ...
                             <div class="form-group">
                                <label class="col-sm-3 control-label"><?php echo ('Student Name');?></label>
                                <div class="col-sm-5">
                                    <select name="student_id" class="form-control" style="width:100%;">
										...
										foreach($teachers as $row):
										?>
                                    		<option value="<?php echo $row['student_id'];?>"><?php echo $row['student_id'];?>-<?php echo $row['name'];?>-<?php echo $row['roll'];?></option>
                                        <?php
										endforeach;
										?>
                                    </select>
