...
<div id="invoice_print"  style="background-image: url('<?php echo base_url(); ?>assets/logoc.png');  background-position: center center; background-size: contain;   background-repeat: no-repeat;">
<?php if ($expense): ?>
